...
const Stats: React.FC = () => {
  return (
    <section className="py-12 md:py-16 bg-primary relative overflow-hidden mt-0 md:-mt-8 mx-0 md:mx-12 md:rounded-3xl shadow-2xl z-30 transform translate-y-0 md:-translate-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {STATS.map((stat, idx) => (
            <div key={stat.id} className="text-center text-white group" data-aos="fade-up" data-aos-delay={idx * 100}>
              <div className="inline-flex items-center justify-center w-12 h-12 md:w-16 md:h-16 bg-white/20 rounded-2xl mb-4 backdrop-blur-sm group-hover:bg-white group-hover:text-primary transition-colors duration-300 transform group-hover:scale-110 shadow-inner">
